...
pub const LINES: &[&str] = &[
    ...
    "",
    "PATH   Type any fixture path or fuzzy query, e.g. notes / nts",
    ...
    "",
    "F5  Reset fixtures · F6  Toggle Copilot availability",
    ...
    "Drag, release, right click and modified clicks are ignored.",
    "",
    "Fixtures: ~/Projects/notes, team notes, café, 修理,",
    "research/notes, current, .archive, it's literal; $HOME",
    "Errors: ~/restricted, ~/broken-link, ~/Projects/missing",
    "",
    "No filesystem, PATH discovery, processes, Zellij or network.",
    "All launches and relative times are fabricated; memory only.",
];
